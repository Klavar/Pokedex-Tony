...
//  Used by Tony Merritt in lesson Pokedex
//
...
open class CSV {
    ...
    public convenience init(contentsOfURL url: String) throws {
        ...
        try self.init(content: csvString,delimiter:(comma as NSCharacterSet) as CharacterSet, encoding:String.Encoding.utf8.rawValue)
    }
